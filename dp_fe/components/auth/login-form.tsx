...
export function LoginForm({ onSuccess, title, description, className }: LoginFormProps) {
  ...
  return (
    <Card className={cn("w-full max-w-lg border-slate-200 bg-white shadow-xl relative z-10 overflow-hidden", className)}>
      <CardHeader className="space-y-4 text-center pt-12 pb-8">
        ...
        <div className="space-y-2">
          <CardTitle className="text-3xl font-extrabold tracking-tight text-slate-900">
            {title || (view === 'login' ? "Sri Ananda" : "Reset Password")}
          </CardTitle>
