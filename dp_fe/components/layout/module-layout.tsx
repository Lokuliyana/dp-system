...
export function ModuleLayout({
  ...
  return (
    <PageContainer variant="fluid" className="h-[calc(100vh-4rem)] p-0">
      <div className="flex h-full">
        {/* Sidebar */}
        <aside className="w-56 border-r border-slate-200 bg-slate-50/50 flex-shrink-0 overflow-y-auto">
            ...
            {navItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={cn(
                    "group flex items-center gap-3 px-4 py-2 text-sm font-medium border-l-2 transition-colors",
                    isActive
